...
curl -fsSL https://raw.githubusercontent.com/laraben/laravel-claude-setup/main/install.sh -o setup-claude.sh
...
**Need help?** [Open an issue](https://github.com/laraben/laravel-claude-setup/issues) or check the [troubleshooting guide](troubleshooting.md).